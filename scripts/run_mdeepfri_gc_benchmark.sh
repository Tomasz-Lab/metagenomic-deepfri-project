...
# Output directory
OUTPUT_DIR="results/landscape_afdb_50k_all_bins"
#OUTPUT_DIR="results/test_raw_alignments/"
...
# Number of top MMSeqs2 hits to save, 0 means all hits
TOP_K=0

# Identity bins (format: "low,high")
# Example: IDENTITY_BINS=("0.9,1.0" "0.8,0.9" "0.7,0.8" "0.6,0.7")
IDENTITY_BINS=("0.90,1.00" "0.80,0.90" "0.70,0.80" "0.60,0.70" "0.50,0.60" "0.40,0.50" "0.30,0.40" "0.20,0.30" "0.10,0.20" "0.00,0.10")
...
SAVE_RAW_ALIGNMENTS=true  # Set to true to save raw alignments (gapped sequences) from pyopal
THREADS=14
SKIP_PDB=true
