...
# Input FASTA file
INPUT_FILE="/home/FilipS/software/mdeepfri_source/Metagenomic-DeepFRI/input_sequences/reference_proteomes.fasta"

# Path to model weights folder
WEIGHTS_PATH="weights_folder/"

# Output directory
OUTPUT_DIR="results/reference_proteomes_rerun/"
...
IDENTITY_BINS=("0.00,0.50" "0.00,0.90" "0.00,1.01")
